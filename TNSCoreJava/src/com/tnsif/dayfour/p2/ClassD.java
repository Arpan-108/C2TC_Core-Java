...
public class ClassD {
	public static void main(String args[]) {
		...
		// System.out.println(objA.protectedNumber); //Protected member is not
		// accessible in another package non-subclass
		// System.out.println(objA.number); //Default member is not accessible in
		// another package
		System.out.println("------------------------------------------------");
	}
}
